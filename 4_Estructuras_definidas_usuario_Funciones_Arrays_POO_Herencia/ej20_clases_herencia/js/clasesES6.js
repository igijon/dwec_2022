...
console.log(
  "perroZombie es una instancia de Object?",
  perroZombie instanceof Object
);
console.log(
  "perroZombie es una instancia de Criatura?",
  perroZombie instanceof Criatura
);
console.log(
  "perroZombie es una instancia de Perro?",
  perroZombie instanceof Perro
);
console.log(
  "perroZombie es una instancia de PerroZombie?",
  perroZombie instanceof PerroZombie
);
